...
<div class="container-new">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="name" required aria-describedby="emailHelp"  placeholder="Enter A Hall Name">
    @error('name')
  ...
  <div class="mb-3">
    ...
    <input type="file" class="form-control" name="img" required id="exampleInputPassword1">
    @error('img')
      <span class="text-danger">{{$message}}</span>
    @enderror
  </div>
